...
void
randombytes_init_saber(unsigned char *entropy_input,
                 ...
                 int security_strength)
{
    ...
    /*  CHANGE  */
    unsigned char personalization_string_internal[48];
    ...
    if (! personalization_string) {
      printf("HERE\n" );
      for (int i=0; i<48; i++) {
        //printf("p[i] : %d\n", personalization_string_internal[i]);
